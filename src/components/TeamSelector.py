...
team_info = pd.read_csv(os.path.join(ROOT_FOLDER,"data/premier_league_teams_standings.csv"))
epl_info = pd.read_csv(os.path.join(ROOT_FOLDER,"data/epl_clubs_info_2022-23.csv"))
