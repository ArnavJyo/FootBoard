...
team_info = pd.read_csv("C:/Users/arnav/Desktop/foot-board/src/data/premier_league_teams_standings.csv")
epl_info = pd.read_csv("C:/Users/arnav/Desktop/foot-board/src/data/epl_clubs_info_2022-23.csv")
