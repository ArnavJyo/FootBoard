...
df = pd.read_csv("C:/Users/arnav/Desktop/foot-board/src/data/Predicted_Standings.csv")
df1 = pd.read_csv('C:/Users/arnav/Desktop/foot-board/src/data/final_prediction.csv')
