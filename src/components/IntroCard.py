    ...
    html.Div(className="card", children=[
        dbc.Row([
            dbc.Col(className="col-lg-6", children=[
                ...
                html.P(["This dashboard presents all you need to know about English Premier League through history: winners, last season analytics, matches, and predicted standings ,results for the current season. You can also check each team's statistics and compare teams with each other in the",
